...
class RegistrationScreen extends StatelessWidget {
      ...
      body: SafeArea(
        child: BlocConsumer<RegistrationBloc, RegistrationState>(
          listener: (context, state) {
            if (state.status == RegistrationStatus.failure && state.generalError != null) {
  ...
  Widget _buildRoleSelection(BuildContext context, RegistrationState state) {
    return Column(
      ...
      children: [
        ...
        if (state.selectedRole == null && state.canSubmit == false && state.termsAccepted)
          Padding(
  ...
  Widget _buildNameFields(BuildContext context, RegistrationState state) {
    return Row(
      children: [
        Expanded(
          child: TextField(
            onChanged: (firstName) {
              context.read<RegistrationBloc>().add(RegistrationFirstNameChanged(firstName));
            },
        ...
        Expanded(
          child: TextField(
            onChanged: (lastName) {
              context.read<RegistrationBloc>().add(RegistrationLastNameChanged(lastName));
            },
            textCapitalization: TextCapitalization.words,
            decoration: InputDecoration(
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: IconButton(
          ...
          onPressed: () {
            context.read<RegistrationBloc>().add(const RegistrationPasswordVisibilityToggled());
          },
        ),
        border: const OutlineInputBorder(),
      ),
  ...
  Widget _buildConfirmPasswordField(BuildContext context, RegistrationState state) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: IconButton(
          ...
          onPressed: () {
            context.read<RegistrationBloc>().add(const RegistrationConfirmPasswordVisibilityToggled());
          },
        ),
        border: const OutlineInputBorder(),
      ),
    ...
    return Row(
      children: [
        Checkbox(
          ...
          onChanged: (value) {
            context.read<RegistrationBloc>().add(RegistrationTermsAccepted(value ?? false));
          },
        ),
        Expanded(
          child: GestureDetector(
            onTap: () {
              context.read<RegistrationBloc>().add(RegistrationTermsAccepted(!state.termsAccepted));
            },
